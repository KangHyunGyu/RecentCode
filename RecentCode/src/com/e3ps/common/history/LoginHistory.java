 ...
 *
 * <p>
 * Use the <code>newLoginHistory</code> static factory method(s), not the
 * <code>LoginHistory</code> constructor, to construct instances of this
...
@GenAsPersistable(
   ...
   @GeneratedProperty(name="browser", type=String.class),
