...
public class SendMailConfig {
	...
	public static String MAIL_HOST = "mproxy01.mailplug.co.kr";  // 기본설정
	public static boolean SESSION_DEBUG_MESSAGE_FLAG = true;
	public static String DEFAULT_SENDER_MAIL_ADDRESS = "shkim@e3ps.com";  // 기본설정	 
	public static String DEFAULT_SENDER_NAME = "PLM관리자";
	public static String CONTENT_TRANSFER_ENCODING = "Content-Transfer-Encoding";
	public static String ADMIN_MAIL_ADDRESS	=	"shkim@e3ps.com";
