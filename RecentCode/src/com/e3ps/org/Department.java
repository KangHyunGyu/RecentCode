...
import com.e3ps.common.impl.Tree;
 ...
 *
 * <p>
 * Use the <code>newDepartment</code> static factory method(s), not the
 * <code>Department</code> constructor, to construct instances of this class.
...
@GenAsPersistable(interfaces={Tree.class}, 
   ...
   @GeneratedProperty(name="name", type=String.class,
      constraints=@PropertyConstraints(upperLimit=90)),
   ...
   @GeneratedProperty(name="oldCode", type=String.class),
   })
