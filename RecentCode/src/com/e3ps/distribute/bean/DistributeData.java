...
public class DistributeData extends AccessControlData{
...
//		this.companyName = StringUtil.checkNull(distribute.getCompanyName());
		...
		WTUser lastAppUser = ApprovalHelper.manager.getLastApprover(distribute);
	...
	public boolean modifyBtn() throws Exception{
		...
		String creatorID = this.distribute.getCreatorName();
