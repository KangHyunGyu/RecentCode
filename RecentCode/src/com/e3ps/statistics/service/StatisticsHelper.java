...
public class StatisticsHelper {
	...
	public int getApprovalCount() throws Exception {
		...
		ClassAttribute ca1 = new ClassAttribute(ApprovalObjectLink.class, WTAttributeNameIfc.ROLEA_CLASSNAME);
		qs.appendSelect(ca1, new int[] { idx1 }, false);
		
		ClassAttribute ca2 = new ClassAttribute(ApprovalObjectLink.class, WTAttributeNameIfc.ROLEA_OBJECT_ID);
		qs.appendSelect(ca2, new int[] { idx1 }, false);
		...
		qs.appendOpenParen();
	 	...
	 	while (qr.hasMoreElements()) {
	 		...
	 		String className = (String)obj[0];
	 		BigDecimal approvalObjId = (BigDecimal)obj[1];
	 		boolean isPermission = AccessControlUtil.checkPermissionForOid(className+":"+String.valueOf(approvalObjId.longValue()));
	 		if(isPermission) ++count;
	 	}
