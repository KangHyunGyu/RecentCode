...
@GenAsBinaryLink(superClass=ObjectToObjectLink.class, 
   ...
   roleA=@GeneratedRole(name="approve", type=MultiApproval.class,
      cardinality=Cardinality.ONE),
   roleB=@GeneratedRole(name="obj", type=Persistable.class),
   tableProperties=@TableProperties(tableName="ApprovalToObjectLink")
)
public class ApprovalToObjectLink extends _ApprovalToObjectLink {
    ...
    **/
   public static ApprovalToObjectLink newApprovalToObjectLink( MultiApproval approve, Persistable obj )
            throws WTException {

      ApprovalToObjectLink instance = new ApprovalToObjectLink();
