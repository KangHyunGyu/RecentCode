 ...
 *
 * <p>
 * Use the <code>newApprovalMaster</code> static factory method(s), not
 * the <code>ApprovalMaster</code> constructor, to construct instances of
...
@GenAsPersistable(interfaces = OwnPersistable.class,serializable=Serialization.EXTERNALIZABLE_BASIC,
   ...
   @GeneratedProperty(name="active", type=int.class),
   @GeneratedProperty(name="completeDate", type=Timestamp.class ,javaDoc="결재 완료일 "),
   @GeneratedProperty(name="objectType", type=String.class, javaDoc="결재 대상 객체 ")
})
public class ApprovalMaster extends _ApprovalMaster {
    ...
    **/
   public static ApprovalMaster newApprovalMaster()
            throws WTException {
