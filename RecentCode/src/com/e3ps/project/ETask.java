 ...
 *
 * <p>
 * Use the <code>newETask</code> static factory method(s), not the <code>ETask</code>
...
@GenAsPersistable(interfaces={ETaskNode.class}, 
   serializable=Serialization.EXTERNALIZABLE_BASIC)
public class ETask extends _ETask {
    ...
    **/
   public static ETask newETask()
            throws WTException {

      ETask instance = new ETask();
      instance.initialize();
      return instance;
   }
