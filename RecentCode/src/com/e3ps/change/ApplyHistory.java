 ...
 * <code>ApplyHistory</code> constructor, to construct instances of this
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   @GeneratedProperty(name="error", type=String.class,
      constraints=@PropertyConstraints(upperLimit=4000))
   },
   foreignKeys={
   @GeneratedForeignKey(name="HistoryEulLink",
      foreignKeyRole=@ForeignKeyRole(name="eul", type=com.e3ps.change.EOEul.class),
...
public class ApplyHistory extends _ApplyHistory {
    ...
    **/
   public static ApplyHistory newApplyHistory()
            throws WTException {
