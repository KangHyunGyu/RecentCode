...
@GenAsPersistable(interfaces={OwnPersistable.class, WTContained.class}, 
   ...
   @GeneratedProperty(name="worker", type=WTPrincipalReference.class)
   },
   foreignKeys={
	@GeneratedForeignKey(name="ActivityDefinitionRootLink", myRoleIsRoleA=false,
		foreignKeyRole=@ForeignKeyRole(name="root", type=com.e3ps.change.EChangeActivityDefinitionRoot.class,
...
public class EChangeActivityDefinition extends _EChangeActivityDefinition {
    ...
    **/
   public static EChangeActivityDefinition newEChangeActivityDefinition()
            throws WTException {
