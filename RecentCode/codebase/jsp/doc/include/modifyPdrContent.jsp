...
function pdrModify_getGridData(pdrMOid) {
...
function pdrM_addRow() {
	var item = new Object();
	AUIGrid.addRow(pdr_content_gridID, item, "last");
}

function pdrM_removeRow() {
...
<div class="seach_arm2 pt10 pb5">
	...
	<div class="rightbt">
		<span id="rootBtn">
			<button type="button" class="s_bt03" onclick="pdrM_addRow()">${e3ps:getMessage('추가')}</button>
			<button type="button" class="s_bt05" onclick="pdrM_removeRow()">${e3ps:getMessage('삭제')}</button>
		</span>
	</div>
</div>
<div class="pb10">
