...
<link rel="stylesheet" href="/Windchill/jsp/stagegate/stagegateHTML/js/gantt_7.0.9_ultimate/codebase/dhtmlxgantt.css">
<script src="/Windchill/jsp/stagegate/stagegateHTML/js/gantt_7.0.9_ultimate/codebase/dhtmlxgantt.js"></script>
<link rel="stylesheet" href="/Windchill/jsp/stagegate/stagegateHTML/js/gantt/css/style.css">
<script src="/Windchill/jsp/stagegate/stagegateHTML/js/gantt/js/zoom.js"></script>
<script src="/Windchill/jsp/stagegate/stagegateHTML/js/gantt/js/zoomToFit.js"></script>
<script src="/Windchill/jsp/stagegate/stagegateHTML/js/gantt/js/gridStruct.js"></script>
<!-- pop -->
<div class="pop5">
	<!-- top -->
	<c:if test="${isSG ne true }">
	<div class="top">
