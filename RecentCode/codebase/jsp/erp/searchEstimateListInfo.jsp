...
var columnLayout = [
	...
	{ dataField : "part_version",		headerText : "${e3ps:getMessage('견적의뢰서 부품 버전')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		}	
	},
	{ dataField : "request_date",		headerText : "${e3ps:getMessage('견적서 마감일')}",		width:"10%",
		filter : {
			showIcon : true,
			iconWidth:30
		}	
...
function getGridData(){
	...
	$("#searchForm").attr("action", getURLString("/erp/searchEstimateListInfoScrollAction"));
...
<div class="product">
		...
		<form name="searchForm" id="searchForm">
			<table class="mainTable">
				...
				<tbody>
					...
					<tr>
						<th scope="col">${e3ps:getMessage('견적의뢰서 부품 번호')}</th>
						<td><input type="text" id="part_number" name="part_number" class="w100"></td>
						<th scope="col">${e3ps:getMessage('견적서 마감일')}</th>
						<td class="calendar">
	...
	<div class="seach_arm pt5 pb5">
		...
		<div class="rightbt">
			...
			<img class="pointer mb5" onclick="excelDown('searchForm', 'excelDownERPEstimateList');" src="/Windchill/jsp/portal/icon/fileicon/xls.gif" border="0">
		</div>
	</div>
	<!-- //button -->
	<!-- table list-->
