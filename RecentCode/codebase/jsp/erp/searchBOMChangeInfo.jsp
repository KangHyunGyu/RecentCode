...
var columnLayout = [
	...
	{ dataField : "op_part_number",		headerText : "${e3ps:getMessage('모 ITEM 번호')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "op_part_version",		headerText : "${e3ps:getMessage('모 ITEM 버전')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "oc_part_number",		headerText : "${e3ps:getMessage('자 ITEM 번호')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "oc_part_version",		headerText : "${e3ps:getMessage('자 ITEM 버전')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "np_part_number",		headerText : "${e3ps:getMessage('모 ITEM 번호')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "np_part_version",		headerText : "${e3ps:getMessage('모 ITEM 버전')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "nc_part_number",		headerText : "${e3ps:getMessage('자 ITEM 번호')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "nc_part_version",		headerText : "${e3ps:getMessage('자 ITEM 버전')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	},
	{ dataField : "nc_part_quantity",		headerText : "${e3ps:getMessage('자 ITEM 수량')}",		width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
...
function getGridData(){
	...
	$("#searchForm").attr("action", getURLString("/erp/searchBOMChangeInfoScrollAction"));
...
<div class="product">
	...
	<div class="seach_arm pt5 pb5">
		...
		<div class="rightbt">
			...
			<img class="pointer mb5" onclick="excelDown('searchForm', 'excelDownERPBOMChange');" src="/Windchill/jsp/portal/icon/fileicon/xls.gif" border="0">
		</div>
	</div>
	<!-- //button -->
	<!-- table list-->
