...
<!-- ECR Issue -->
<jsp:include page="${e3ps:getIncludeURLString('/erp/include_relatedECRIssue')}" flush="true">
	<jsp:param name="ecr_number" value="${ecr_number}"/>
	<jsp:param name="gridHeight" value="200"/>
</jsp:include>
<!-- BOM -->
<jsp:include page="${e3ps:getIncludeURLString('/erp/include_relatedBOM')}" flush="true">
