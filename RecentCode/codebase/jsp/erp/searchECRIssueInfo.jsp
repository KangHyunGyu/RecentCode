...
function getGridData(){
	...
	$("#searchForm").attr("action", getURLString("/erp/searchECRIssueInfoScrollAction"));
...
<div class="product">
			...
			<table class="mainTable">
				...
				<tbody>
					<tr>
						...
						<th scope="col">${e3ps:getMessage('ISSUE 번호')}</th>
	...
	<div class="seach_arm pt5 pb5">
		...
		<div class="rightbt">
			...
			<img class="pointer mb5" onclick="excelDown('searchForm', 'excelDownERPECRIssue');" src="/Windchill/jsp/portal/icon/fileicon/xls.gif" border="0">
		</div>
	</div>
	<!-- //button -->
	<!-- table list-->
