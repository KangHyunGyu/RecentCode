...
function loadIncludePage(tab) {
	...
	param["instance_id"] = "${ecr.instance_id}";
	param["ecr_number"] = "${ecr.ecr_number}";
	param["pjt_number"] = "${ecr.pjt_no}";
...
<div class="pop">
	...
	<div class="tap pt20">
		<ul>
			<li onclick="loadIncludePage(this);" data-url="${e3ps:getURLString('/erp/include_detailECRInfo')}">${e3ps:getMessage('세부 내용')}</li>
			<li onclick="loadIncludePage(this);" data-url="${e3ps:getURLString('/erp/include_relatedObject')}">${e3ps:getMessage('관련 객체')}</li>
		</ul>
		<div class="tapbutton">
