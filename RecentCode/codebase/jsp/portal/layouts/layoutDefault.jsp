...
<!-- 		<link rel="stylesheet" href="/Windchill/jsp/component/spreadsheet/spreadsheet.css?v=8.0.2" type="text/css"> -->
<!-- 		<script src="/Windchill/jsp/component/spreadsheet/spreadsheet.js?v=8.0.2" type="text/javascript" charset="utf-8"></script> -->
		...
		<!-- HighCharts -->
		<script type="text/javascript" src="/Windchill/jsp/component/highcharts/highcharts.js" ></script>
		<script type="text/javascript" src="/Windchill/jsp/component/highcharts/xrange.js"></script>
