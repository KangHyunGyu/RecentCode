...
<div class="pop">
	...
	<div class="top">
		...
		${e3ps:getMessage('배포파일 정보')} - ${data.distributeNumber}, ${data.number}
		</h2>
	...
	<div class="tap pt20">
		<ul>
			<li onclick="loadIncludePage(this);" data-url="${e3ps:getURLString('/distribute/include_detailItemInfo')}">${e3ps:getMessage('세부 내용')}</li>
		</ul>
		<div class="tapbutton">
		</div>
	</div>
