...
var rel_epm_columnLayout = [
	{ dataField : "number",				headerText : "${e3ps:getMessage('번호')}",			width:"15%",		style:"AUIGrid_Left",
		filter : {
			showIcon : true,
			iconWidth:30
		},
...
function rel_epm_setSorting() {
	//mNumber,pporderAX,orderDate
	var sortingInfo = [];
	
	sortingInfo[0] = { dataField : "number", sortType : 1 };
	AUIGrid.setSorting(rel_epm_myGridID, sortingInfo);
}
