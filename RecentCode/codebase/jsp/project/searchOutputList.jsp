			...
			<table class="mainTable">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" id="number" name="pjtNumber" class="w100"></td>
						<th scope="col">${e3ps:getMessage('프로젝트 명')}</th>
						<td><input type="text" id="name" name="pjtName" class="w100"></td>
					</tr>
					<tr>
						<th scope="col">${e3ps:getMessage('테스크 명')}</th>
						<td><input type="text" id="taskName" name="taskName" class="w100"></td>
						<th scope="col">${e3ps:getMessage('문서 명')}</th>
						<td><input type="text" id="docName" name="docName" class="w100"></td>
					</tr>
				</tbody>
			</table>
		</form>	
...
var columnLayout = [
	...
	{
		dataField: "taskName",
		headerText: "${e3ps:getMessage('태스트 명')}",
		width: "10%",
		sortValue: "taskName",
		filter: {
			showIcon: true,
...
function getGridData(){
	$("#searchForm").attr("action", getURLString("/project/searchOutputScrollAction"));
