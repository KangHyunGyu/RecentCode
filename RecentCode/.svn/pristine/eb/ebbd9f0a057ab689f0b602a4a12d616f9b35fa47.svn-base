...
var ${type}_bom_part_columnLayout = [
	...
	{ dataField : "name",				headerText : "${e3ps:getMessage('부품 명')}",			width:"40%",		style:"AUIGrid_Left",
		filter : {
			showIcon : true,
			iconWidth:30
		}		
...
function ${type}_bom_part_getGridData(){
	...
	var url = getURLString("/bom/getOldBomPartList");
...
<!-- //button -->
<div class="list" id="${type}_bom_part_grid_wrap" style="height:${gridHeight}px">
</div>