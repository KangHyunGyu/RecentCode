...
public class EChangeActivityDefinitionRoot extends _EChangeActivityDefinitionRoot {
    ...
    **/
   public static EChangeActivityDefinitionRoot newEChangeActivityDefinitionRoot()
            throws WTException {

	   EChangeActivityDefinitionRoot instance = new EChangeActivityDefinitionRoot();
      instance.initialize();
      return instance;
   }
