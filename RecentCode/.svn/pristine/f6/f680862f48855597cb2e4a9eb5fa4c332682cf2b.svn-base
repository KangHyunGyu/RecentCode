...
$(document).ready(function(){
	...
	$("#state option[value='TEMP_STORAGE']").remove();
...
var columnLayout = [
	...
	{ dataField : "ownerFullName",		headerText : "${e3ps:getMessage('등록자')}",		width:"10%",
		filter : {
			showIcon : true,
			iconWidth:30
		}	
...
function getGridData(){
	...
	$("#searchForm").attr("action", getURLString("/workspace/listSendItemScrollAction"));
			...
			<table class="mainTable">
				...
				<tbody>
					...
					<tr>
						...
						<td class="calendar">
							<input type="text" class="datePicker w25" name="predate_completeDate" id="predate_completeDate" readonly/>
							~
							<input type="text" class="datePicker w25" name="postdate_completeDate" id="postdate_completeDate" readonly/>
						</td>
					</tr>
					</c:if>
<%-- 					<c:if test= "${e3ps:isAdmin()}"> --%>
...
<!-- 						<td colspan="3"> -->
<!-- 							<div class="pro_view"> -->
<!-- 								<select class="searchUser w50" id="creator" name="creator" multiple> -->
<!-- 								</select> -->
<!-- 							</div> -->
<!-- 						</td> -->
<!-- 						<td> -->
