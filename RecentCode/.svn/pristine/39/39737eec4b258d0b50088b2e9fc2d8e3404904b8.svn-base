...
function bom_item_getGridData(){
	...
	var url = getURLString("/bom/getOldBomItemList");
	ajaxCallServer(url, param, function(data){

		// 그리드 데이터
		var gridData = data.list;
		
		$("#total").html(gridData.length + gridData[0].children.length);
...
<!-- //button -->
<div class="list" id="bom_item_grid_wrap" style="height:${gridHeight}px">
</div>