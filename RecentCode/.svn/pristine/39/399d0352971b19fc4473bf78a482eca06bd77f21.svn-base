...
public class DistributePartToEpmData {
	
	// VIEW DATA
		private String pOid;					// 구매요청 품목 OID
		private String pIcon;					// 구매요청 품목 아이콘
		private String partNumber;				// 구매요청 품목 번호
		private String partName;				// 구매요청 품목 명
		private String partVersion;				// 구매요청 품목 버전
		private String partState;				// 구매요청 품목 상태
		private String disOid;					// 구매요청 배포문서 OID
		private String disIcon;					// 구매요청 배포문서 아이콘
		private String disNumber;				// 구매요청 배포문서 번호
		private String disName;					// 구매요청 배포문서 명
		private String disFileName;				// 구매요청 배포문서 파일이름
		private String disVersion;				// 구매요청 배포문서 버전
		private String disState;				// 구매요청 배포문서 상태
		
		// DISTRIBUTE DATA - EPMDocument
		private String dwgAppOid; 				// 구매요청 품목 DWG AppData oid
		private String pdfAppOid; 				// 구매요청 품목 PDF AppData oid
		private String dwgAppFileName; 			// 구매요청 품목 DWG 파일 이름
		private String pdfAppFileName;			// 구매요청 품목 PDF 파일 이름
		
		
		private List<ApplicationData> dataList;
		
		public DistributePartToEpmData(DistributePartToEpmLink link) {
			super();
			
			
			Persistable per = link.getDistributePartToEpm();
			WTPart part = link.getDistributePart().getPart();
