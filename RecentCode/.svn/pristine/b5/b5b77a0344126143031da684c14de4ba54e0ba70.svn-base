 ...
 *
 * <p>
 * Use the <code>newChangeOutput</code> static factory method(s), not the
 * <code>ChangeOutput</code> constructor, to construct instances of this
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   foreignKeys={
   @GeneratedForeignKey(name="ChangeOrderOutputLink",
      foreignKeyRole=@ForeignKeyRole(name="order", type=com.e3ps.change.EChangeOrder2.class),
      myRole=@MyRole(name="output"))
   })
public class ChangeOutput extends _ChangeOutput {
    ...
    **/
   public static ChangeOutput newChangeOutput()
            throws WTException {

      ChangeOutput instance = new ChangeOutput();
      instance.initialize();
      return instance;
   }
