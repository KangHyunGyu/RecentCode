...
package com.e3ps.groupware.board;
 ...
 *
 * <p>
 * Use the <code>newBoardComent</code> static factory method(s), not the
 * <code>BoardComent</code> constructor, to construct instances of this
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   properties={
   @GeneratedProperty(name="coment", type=String.class,
      constraints=@PropertyConstraints(upperLimit=6000))
   },
   foreignKeys={
   @GeneratedForeignKey(name="BoardComentLink",
      foreignKeyRole=@ForeignKeyRole(name="board", type=com.e3ps.groupware.board.Board.class,
         constraints=@PropertyConstraints(required=true)),
      myRole=@MyRole(name="coment"))
   })
public class BoardComent extends _BoardComent {
    ...
    **/
   public static BoardComent newBoardComent()
            throws WTException {

      BoardComent instance = new BoardComent();
      instance.initialize();
      return instance;
   }
