...
var rel_epm_columnLayout = [
	...
	*/
	...
	{ dataField : "modifyDateToMinute",			headerText : "${e3ps:getMessage('최종 수정일')}",			width:"12%",
		filter : {
			showIcon : true,
			iconWidth:30
		}	
...
function rel_epm_getGridData(){
	...
	var url = getURLString("/epm/getRelatedEpm");
...
<div class="seach_arm2 pt10 pb5">
	<div class="leftbt"><h4><img class="pointer" onclick="switchPopupDiv(this);" src="/Windchill/jsp/portal/images/minus_icon.png"> ${e3ps:getMessage('관련 도면')}</h4></div>
	<div class="rightbt">
...
<!-- //button -->
<div class="list" id="rel_epm_grid_wrap" style="height:200px">
</div>