...
<div class="pop5">
	<!-- top -->
	<div class="top">
		<h2>${e3ps:getMessage('프로젝트 선행 Task')}</h2>
...
function getGridData(){
	...
	var url = getURLString("/project/getProjectTree");
...
function getPreTask() {
	...
	var url = getURLString("/project/getPreTask");
	ajaxCallServer(url, param, function(data){
...
function getPostTask() {
	...
	var url = getURLString("/project/getPostTask");
	ajaxCallServer(url, param, function(data){
...
function addPreTask() {
	...
	var url = getURLString("/project/setPreTask");
	ajaxCallServer(url, param, function(data){
