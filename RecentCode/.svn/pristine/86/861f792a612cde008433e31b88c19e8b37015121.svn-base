...
<div class="pop">
	<!-- top -->
	<div class="top">
		<h2>${e3ps:getMessage('배포 요청서')} - ${distribute.distNumber}, ${distribute.distName} </h2>
...
<div class="seach_arm pt20 pb5">
	<div class="leftbt">
		<h4><img class="pointer" onclick="switchPopupDiv(this);" src="/Windchill/jsp/portal/images/minus_icon.png"> ${e3ps:getMessage('기본 정보')}</h4></div>
	<div class="rightbt">
	</div>
</div>
<!-- pro_table -->
<div class="pro_table" style="padding-left: 30px; padding-right: 30px;">
	...
	<div class="ml30 mr30">
		<jsp:include
			page="${e3ps:getIncludeURLString('/part/include_relatedPart')}"
			flush="true">
