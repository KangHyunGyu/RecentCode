 ...
 *
 * <p>
 * Use the <code>newEProjectTemplate</code> static factory method(s), not
 * the <code>EProjectTemplate</code> constructor, to construct instances
...
@GenAsPersistable(interfaces={EProjectNode.class}, 
   serializable=Serialization.EXTERNALIZABLE_BASIC,
   properties={
   @GeneratedProperty(name="enabled", type=boolean.class),
   @GeneratedProperty(name="creator", type=WTPrincipalReference.class,
      constraints=@PropertyConstraints(required=true),
      columnProperties=@ColumnProperties(columnName="C"))
   })
public class EProjectTemplate extends _EProjectTemplate {
    ...
    **/
   public static EProjectTemplate newEProjectTemplate()
            throws WTException {

      EProjectTemplate instance = new EProjectTemplate();
      instance.initialize();
      return instance;
   }
