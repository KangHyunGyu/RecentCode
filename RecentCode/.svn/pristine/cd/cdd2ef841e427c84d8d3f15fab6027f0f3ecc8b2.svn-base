 ...
 *
 * <p>
 * Use the <code>newHoliday</code> static factory method(s), not the <code>Holiday</code>
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="holiday", type=String.class),
   @GeneratedProperty(name="enable", type=boolean.class)
   })
public class Holiday extends _Holiday {
    ...
    **/
   public static Holiday newHoliday()
            throws WTException {

      Holiday instance = new Holiday();
      instance.initialize();
      return instance;
   }
