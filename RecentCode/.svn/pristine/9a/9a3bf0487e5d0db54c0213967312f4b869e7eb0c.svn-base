...
<div class="product">
	...
	<div class="semi_content pl30 pr30">
		<div class="semi_table1 pr20" id="PSOTree">
			<jsp:include page="/jsp/project/include/PSOTree.jsp">
				<jsp:param name="codetype" value="PSO"/>
...
webix.ready(function(){
	var grid = webix.ui({
		...
		columns:[
			...
			{ id:"code", header:["${e3ps:getMessage('코드')}"],	width:150, editor:"text", sort:"string",
			...
			{ id:"description", header:"${e3ps:getMessage('설명')}", width:500, editor:"text",sort:"string",
			},
...
function getGridData() {
	$("#searchForm").attr("action", getURLString("/admin/getPSOCodeList"));
...
function removeRow() {
	...
	for(var i = 0; i < checkList.length; i++){
		if(checkList[i].mark == "On"){
			...
			if(checkList[i].oid != null && checkList[i].newItem != true){
...
function save() {
	...
	var url = getURLString("/admin/savePSOCodeAction");
