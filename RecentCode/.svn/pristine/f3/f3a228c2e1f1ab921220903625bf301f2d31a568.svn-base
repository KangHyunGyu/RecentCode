...
<!-- //button -->
<div class="list" id="rel_part_grid_wrap" style="height:200px">
</div>
<script>
...
var rel_part_columnLayout = [
	{ dataField : "number", headerText : "${e3ps:getMessage('부품 번호')}", width:"15%",
		filter : {
			showIcon : true,
			iconWidth:30
		},
	...
	{ dataField : "name", headerText : "${e3ps:getMessage('부품 명')}", width:"*%", style:"AUIGrid_Left",
		filter : {
			showIcon : true,
			iconWidth:30
		},
