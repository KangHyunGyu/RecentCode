...
public final class JobTypeResource extends WTListResourceBundle {
    ...
    @RBEntry("E3PS Job")
    @RBComment("Plural name to display for E3PS Job")
    public static final String e3psJob = "e3psJob";

    @RBEntry("E3PS Jobs")
    @RBComment("Plural name to display for E3PS Jobs")
    public static final String e3psJobs = "e3psJobs";
}
