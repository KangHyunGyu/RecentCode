...
webix.ready(function(){
	var grid = webix.ui({
		...
		datafetch:50,
		columns:[
			{ id : "distributeNumber",		header : "${e3ps:getMessage('배포 번호')}",		width:"140",	
			...
			{ id : "distributeName",		header : "${e3ps:getMessage('배포 제목')}",		width:"180", fillspace: true,		
				css: "custom_webix_ellipsis",
			},
			{ id : "pjtNo",		header : "${e3ps:getMessage('프로젝트 번호')}",		width:"140",
				css: "custom_webix_ellipsis custom_webix_center",
			},
			{ id : "requestNumber",		header : "${e3ps:getMessage('발주 번호')}",		width:"140",
				css: "custom_webix_ellipsis custom_webix_center",
			},
			{ id : "supplierName",		header : "${e3ps:getMessage('배포 업체')}",		width:"180",	
				css: "custom_webix_ellipsis",
			},
			{ id : "createDateFormat",		header : "${e3ps:getMessage('작성일')}",		width:"140",
				css: "custom_webix_ellipsis custom_webix_center",
			},
			{ id : "requesterName",		header : "${e3ps:getMessage('담당자')}",		width:"140",
				css: "custom_webix_ellipsis custom_webix_center",
			},
		],
		on:{
