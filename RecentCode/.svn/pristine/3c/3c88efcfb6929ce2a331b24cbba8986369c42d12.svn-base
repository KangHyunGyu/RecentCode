 ...
 *
 * <p>
 * Use the <code>newDownloadHistory</code> static factory method(s), not
 * the <code>DownloadHistory</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="dOid", type=String.class),
   @GeneratedProperty(name="dCount", type=int.class),
   @GeneratedProperty(name="name", type=String.class),
   @GeneratedProperty(name="id", type=String.class),
   @GeneratedProperty(name="downloadDate", type=Timestamp.class),
   @GeneratedProperty(name="fName", type=String.class),
   @GeneratedProperty(name="ip", type=String.class)
   },
   foreignKeys={
   @GeneratedForeignKey(name="HistoryUserLink", myRoleIsRoleA=false,
...
public class DownloadHistory extends _DownloadHistory {
    ...
    **/
   public static DownloadHistory newDownloadHistory()
            throws WTException {
