...
public class DocLocation extends _DocLocation {
    ...
    **/
   public static DocLocation newEpmLocation()
            throws WTException {

	   DocLocation instance = new DocLocation();
      instance.initialize();
      return instance;
   }
