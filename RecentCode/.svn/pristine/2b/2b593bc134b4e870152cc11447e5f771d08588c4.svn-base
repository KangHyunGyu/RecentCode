 ...
 * ???? ??
 * <p>
 * Use the <code>newProjectRole</code> static factory method(s), not the
 * <code>ProjectRole</code> constructor, to construct instances of this
...
@GenAsPersistable(
   ...
   @GeneratedForeignKey(name="ProjectRoleLink",
      ...
      myRole=@MyRole(name="role"))
   })
public class ProjectRole extends _ProjectRole {
    ...
    **/
   public static ProjectRole newProjectRole()
            throws WTException {

      ProjectRole instance = new ProjectRole();
      instance.initialize();
      return instance;
   }
