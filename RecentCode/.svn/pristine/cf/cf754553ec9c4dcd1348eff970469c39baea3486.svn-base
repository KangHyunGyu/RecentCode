 ...
 *
 * <p>
 * Use the <code>newApplyChangeState</code> static factory method(s), not
 * the <code>ApplyChangeState</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   @GeneratedProperty(name="assyNumber", type=String.class),
   @GeneratedProperty(name="assyVersion", type=String.class),
   @GeneratedProperty(name="error", type=String.class,
      constraints=@PropertyConstraints(upperLimit=4000))
   },
   foreignKeys={
   @GeneratedForeignKey(name="HistoryChangeLink",
      foreignKeyRole=@ForeignKeyRole(name="history", type=com.e3ps.change.ApplyHistory.class),
      myRole=@MyRole(name="change"))
   })
public class ApplyChangeState extends _ApplyChangeState {
    ...
    *
    * @return    ApplyChangeState
    * @exception wt.util.WTException
    **/
   public static ApplyChangeState newApplyChangeState()
            throws WTException {

      ApplyChangeState instance = new ApplyChangeState();
      instance.initialize();
      return instance;
   }
